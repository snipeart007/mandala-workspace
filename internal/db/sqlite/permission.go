...
func (self *SQLiteManager) GetUserPermissionBitmask(userID uint64, folderID uint64) (uint64, error) {
	slog.Debug("Getting user permission bitmask", "user_id", userID, "folder_id", folderID, "db_type", "sqlite")
...
func (self *SQLiteManager) GetUserEffectivePermissions(userID uint64, folderID uint64) (uint64, error) {
	slog.Debug("Calculating effective permissions", "user_id", userID, "folder_id", folderID, "db_type", "sqlite")
...
func (self *SQLiteManager) SetUserPermission(userID uint64, folderID uint64, permissions uint64) error {
	slog.Info("Setting user permission", "user_id", userID, "folder_id", folderID, "permissions", permissions, "db_type", "sqlite")
	_, err := self.db.Exec(`
